...
class Locale extends Base
{
     ...
     * Load
     *
     * Load a specific file and append data to the
     * current locale dictionnary
     *
    ...
    {
        Application::$instance->session->set('app_language', $code);
     ...
     *
     * @param   string  application language
     * @access  public
     * @static
     *
     */
    ...
    {
        $config = Configuration::get('configuration', 'localization');
